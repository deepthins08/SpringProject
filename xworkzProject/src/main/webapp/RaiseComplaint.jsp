        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item me-3 mt-2">
                    <a class="nav-link active text-dark fs-5 fw-bold" aria-current="page" href="Home.jsp">Home</a>
                </li>
                <li class="nav-item">
...
<c:choose>
    <c:when test="${action == 'edit'}">
        <form action="editComplaintData" method="post">
    </c:when>
    <c:otherwise>
                    ...
                    <div class="row">
                        <div class="col">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <input type="submit" value="Submit" name="btn" id="btn" class="btn btn-primary me-5" disabled>
                                </c:otherwise>
                            </c:choose>
                        </div>
                        <div class="col">
