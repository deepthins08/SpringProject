...
function emailValidation() {
    ...
    xhr.open("GET", `/xworkzProject/departmentAdmin/emailValidation?email=${encodeURIComponent(email)}`, true);
...
function phoneValidation() {
    ...
    let xhr = new XMLHttpRequest();
    xhr.open("GET", `http://localhost:8080/xworkzProject/departmentAdmin/phoneValidation?phone=${encodeURIComponent(phone)}`, true);
