...
<div class="container mb-5  d-flex justify-content-center">
        <div class="card px-5 py-4 bg-light w-100 shadow-lg p-3 mb-5 bg-white rounded" style="max-width: 600px;">
            <div class="mb-1 mt-3">
    <a class="dropdown-item fs-2" href="/xworkzProject/downloadComplaints">Download Complaints</a>
            </div>
        </div>
    </div>
...
<script>
 ...
 function toggleSidebar() {
  ...
  function openComplaint(complaintId) {
         ...
         fetch('/xworkzProject/markUserNotificationAsRead?notificationId=' + complaintId)
             ...
             .then(result => {
                 if (result === 'success') {
                     ...
                     window.location.href = '/xworkzProject/viewUserComplaints?id=' + complaintId;
                 } else {
     ...
     function fetchNotifications() {
             fetch('/xworkzProject/getUserNotifications')
