...
<div id="notificationSidebar" class="notification-sidebar">
    ...
    <div class="notification-list">
        <c:forEach var="notification" items="${sessionScope.notifications}">
            <div class="notification-item ${notification.employeeRead ? 'employeeRead' : ''}" onclick="openComplaint(${notification.id})">
...
<div class="container mt-5 mb-5 d-flex justify-content-center">
        ...
        <div class="container mb-5  d-flex justify-content-center">
                    <div class="card px-5 py-4 bg-light w-100 shadow-lg p-3 mb-5 bg-white rounded" style="max-width: 600px;">
                        <div class="mb-1 mt-3">
                <a class="dropdown-item fs-2" href="/xworkzProject/downloadEmployeeComplaints">Download Complaints</a>
                        </div>
                    </div>
                </div>
...
<script>
  ...
  function openComplaint(complaintId) {
         ...
         fetch('/xworkzProject/markEmployeeNotificationAsRead?notificationId=' + complaintId)
             ...
             .then(result => {
                 if (result === 'success') {
                     ...
                     window.location.href = '/xworkzProject/viewEmployeeComplaints?id=' + complaintId;
                 } else {
     ...
     function fetchNotifications() {
             fetch('/xworkzProject/getEmployeeNotifications')
