...
public class SignUpRepoImpl implements SignUpRepo{
    ...
    @Override
    public SignUpDTO findByUserId(int id) {
        EntityManager entityManager= this.entityManagerFactory.createEntityManager();

        SignUpDTO employee = entityManager.find(SignUpDTO.class, id);
        return employee;
    }
    ...
    public void markNotificationAsRead(int id) {
        ...
        try {
            entityTransaction.begin();
            entityManager.createQuery("UPDATE ComplaintsDTO c SET c.userRead = true WHERE c.id = :complaintId")
    ...
    public List<ComplaintsDTO> findUnread() {
        EntityManager entityManager = this.entityManagerFactory.createEntityManager();
        try {
            Query query = entityManager.createQuery("SELECT c FROM ComplaintsDTO c WHERE c.userRead = false", ComplaintsDTO.class);
