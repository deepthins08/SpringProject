...
public class SignUpServiceImpl implements SignUpService {
    ...
    public boolean ValidateAndSave(SignUpDTO signUpDTO) {
        ...
        String encryptPassword=passwordEncoder.encode(generatedPassword);


        signUpDTO.setPassword(encryptPassword);

        sendPassword(signUpDTO,generatedPassword);
    ...
    public void sendPassword(SignUpDTO signUpDTO,String decryptPassword) {
    ...
    public boolean markAsRead(int id) {
        signUpRepo.markNotificationAsRead(id);
        return true;
    }

    @Override
    public List<ComplaintsDTO> getUnreadNotifications() {
        return signUpRepo.findUnread();
    }
